...
export default defineConfig(({ mode }) => {
  ...
  const proxyConfig = {
    ...
    '^/api/(predict|predict_double|predict_pose|detect_frame|detect_landmarks|detect_double_landmarks|detect_holistic|evaluate_session|session_report|landmarks|mudra_data|clear_history|reset_registry|get_voice|sequence)': {
